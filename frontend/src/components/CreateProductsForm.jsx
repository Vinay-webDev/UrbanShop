...
const categories = ["jeans", "t-shirts", "shoes", "glasses", "jackets", "suits", "bags", "shirts", "watch"];
...
const CreateProductsForm = () => {
  ...
  return (
    <motion.div
		...
		>
      <h2 className='text-2xl font-semibold mb-6 text-gray-400' >Create New Product</h2>
